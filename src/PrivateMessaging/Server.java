...
import java.net.*;// socket package

public class Server implements ActionListener {// frame from swing package 
    
    JTextField text;//global declaration
    
    JPanel a1;// global declaration of pannel to write message in it
    
    static Box vertical = Box.createVerticalBox();
    
    static JFrame f = new JFrame();// class object 
    
    static  DataOutputStream dout; //global declaration
    
    
    Server(){// after making class object there will be a constructor call 
    ...
    // use image class to scale image to good looks    
        ...
        JLabel name = new JLabel("IT Professional");
        ...
        // active now status
        JLabel status = new JLabel("Chand pe Hai");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        dout.writeUTF(out);//read message      
    ...
    public static void main (String[] args){
        new Server();//announnoumous object
        
        try {
            ServerSocket skt = new ServerSocket(6001);// creation of server and in clints we had to make sockets can me one or multipple 
            while(true){// imfinite while loop to accept message and send
                Socket s = skt.accept();
            ...
            e.printStackTrace();// error ko catch karne ke lie try or catch banana padta hai
